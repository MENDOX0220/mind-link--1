<template>
    <div id="register">
        <form class="box" @submit="submit">
            ...
            v-model="nickname" :class="{'input-err':err_nickname}">
            <div style="color: red;">{{err_nickname}}</div>
            <input type="password" name="password" placeholder="비밀번호" 
            v-model="password" :class="{'input-err':err_password}">
    ...
    export default {
        ...
        methods:{
            submit(e){
                ...
                //폼 확인
                if(this.username == "")
                    this.err_username = "아이디를 입력해주세요";
                if(this.nickname == "")
                    this.err_nickname = "별명을 입력해주세요";
                if(this.password == "")
                    this.err_password = "비밀번호를 입력해주세요";
